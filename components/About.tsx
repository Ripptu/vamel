...
export const About: React.FC = () => {
  return (
    <Section id="about" className="!py-0 !pb-0">
      {/* Tighter padding (p-4) to reduce overall size */}
      <Card className="p-4 bg-gradient-to-b from-[#121212] to-black border-white/5">
        
        {/* Compact Grid: reduced gap and offset */}
        <div className="grid grid-cols-2 gap-3 mb-3">
            ...
            <motion.div 
               whileHover={{ scale: 1.02 }}
               // Reduced margin-top from 6 to 4 to minimize vertical empty space
               className="relative w-full aspect-[4/5] rounded-2xl overflow-hidden border border-white/10 mt-4"
            >
                <img 
        ...
        <div>
            <h3 className="text-lg font-black mb-1.5 tracking-tight text-white uppercase">
            ...
            <p className="text-gray-400 text-sm leading-snug font-medium">
                ...
                Ehrlich, direkt und mit Bock auf Ergebnisse.
            </p>
        </div>
      </Card>
    </Section>
